...
if __name__ == "__main__":
    ...
    # --- robust model loader ---
    checkpoint_path = "./checkpoints/model_n-datasets_1_forcing_0.5_time-window_5_unroll-steps_3_coarsen_2-2_target_delta_epoch_1.pt"
    ...
    sim_idx = 0
    t_idx = 0
    save_path = f"./rollouts/rollout_1datasets_weak_forcing_sim{sim_idx}_t{t_idx}_time-window_{time_window}_coarsen_{coarsen[0]}-{coarsen[1]}_target_{target}_train.npz"
